...
.. container:: snum
   ...
   :ref:`3 <9899_7.19.4.2p3>`

The rename function returns zero if the operation succeeds, nonzero if it fails,\ [#9899_note235]_ in which case if the file existed previously it is still known by its original name.
