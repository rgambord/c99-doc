...
Each of the operators \< (less than), > (greater than), <= (less than or equal to), and >= (greater than or equal to) shall yield 1 if the specified relation is true and 0 if it is false.\ [#9899_note92]_ The result has type int.
