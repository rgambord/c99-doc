...
The header :ref:`\<errno.h> <9899_7.5>` defines several macros, all relating to the reporting of error conditions.
...
Additional macro definitions, beginning with E and a digit or E and an uppercase letter,\ [#9899_note177]_ may also be specified by the implementation.
