...
The argument in any instance of these macros shall be an unsuffixed integer constant (as defined in :ref:`6.4.4.1 <9899_6.4.4.1>`) with a value that does not exceed the limits for the corresponding type.
